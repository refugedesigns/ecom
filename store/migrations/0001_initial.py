    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='primary_products', to='store.category')),
                ('secondary_categories', models.ManyToManyField(blank=True, to='store.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
